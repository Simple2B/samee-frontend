              ...
              <>
                ...
                <div className="pop_up">
                  ...
                  <div className="pop_up_text">
                    ...
                    investisseurs immobiliers ou les entrepreneurs qui
                    souhaitent lancer leur projet.
                  </div>
                  <div className="pop_up_text">
                  ...
                  <div className="pop_up_text">
                    ...
                    de votre 3ème pilier pour la construction d’une piscine,
                    d’un hammam ou d’un garage n’est pas autorisé.
                  </div>
                  <div className="pop_up_text">
                  ...
                  <div className="pop_up_text">
                    c. Vous créez votre entreprise en tant qu’indépendant ou
                    vous êtes inscrit en tant que travailleur indépendant à
                    l’AVS.
                  </div>
                  ...
                  <div className="pop_up_text">
                    ...
                    dans les premières années de votre contrat. C’est-à-dire
                    qu’un retrait de votre troisième pilier n’est pas optimisé
                    dans cette situation.
                  </div>

                  <div className="pop_up_text">
                    Toutefois, vous pouvez mettre votre troisième pilier en
                    nantissement, c’est-à-dire qu’il vous servira de garantie
                    pour votre hypothèque. Il est plus avantageux que le retrait
                    de capital pour lequel vous êtes imposé et vous risquez de
                    ne pas récupérer l’entièreté de vos cotisations.
                  </div>

                  <div className="pop_up_text">
                    En choisissant cette solution et ainsi continuant de cotiser
                    au 3ème pilier, vous bénéficiez toujours des prestations en
                    cas d’invalidité ou de décès. Dans ces deux cas, votre
                    famille n’aura pas à prendre en charge votre hypothèque, car
                    l’assurance s’en chargera. Le nantissement vous permet de
                    bénéficier de tous les avantages du 3ème pilier en
                    remboursant votre crédit hypothécaire.
                  </div>
                </div>
              </>
            )}
