            ...
            {(
              ...
              <>
                ...
                <div className="pop_up">
                  ...
                  <div className="pop_up_text">
                    Dans le cas d’un salarié, vous pouvez économiser jusqu’à
                    6’883 CHF par an.
                  </div>
                  <div className="pop_up_text">
                    Dans le cas d’un indépendant, comme le 2ème pilier n’est pas
                    obligatoire, s’il décide de ne pas y souscrire, il a la
                    possibilité de verser 34’416 CHF ou jusqu’à 20% de son
                    salaire AVS dans un 3ème pilier. Si un indépendant est
                    affilié au 2ème pilier, la cotisation maximale de son 3ème
                    pilier sera la même que celle d’un salarié.
                  </div>
                </div>
              </>
            )}
