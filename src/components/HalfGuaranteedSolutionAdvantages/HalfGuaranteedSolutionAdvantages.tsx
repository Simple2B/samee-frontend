  ...
  return (
    <div className="half_guaranteed_advantages">
      ...
      <div className="half_guaranteed_advantages_text">
        Vous bénéficiez d’une performance plus élevée que sur un compte épargne
        classique. Ceci, grâce à des taux de rendement moyens sur la partie en
        fonds entre 3% et 7 % (selon les performances historiques).
      </div>
      <div className="half_guaranteed_advantages_text">
