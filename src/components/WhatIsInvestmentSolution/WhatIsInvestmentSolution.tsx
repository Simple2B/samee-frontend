...
export default function WhatIsInvestmentSolution(): ReactElement {
  ...
  return (
    <div className="what_is_investment-solution">
      ...
      <div className="what_is_investment-solution_text">
        Le plus souvent, les produits de placements sont diversifiés pour
        assurer un risque modéré. Vous avez la possibilité de choisir les fonds
        qui vous intéressent.
      </div>
      <div className="what_is_investment-solution_text">
        Vous pouvez choisir des fonds plus ou moins risqués avec une proportion
        d’actions plus ou moins élevées selon votre profil d’investisseur.
        Gardez en tête que plus la part en action est élevée, plus le risque et
        le rendement le sont également. Vous pouvez aussi modifier l’allocation
