...
export default function PercentCalc(): ReactElement {
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem('amountFonds', JSON.stringify(amountFonds));
    ...
    <div className="percent_calc">
      <div className="main_content">
        ...
        <div className="percent_calc_text">
          ...
          Selon les conditions du marché, votre partie en fonds vous rapportera
          un taux d'intérêt plus ou moins grand.
        </div>
      </div>
