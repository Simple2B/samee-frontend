          ...
          <>
            ...
            <div className="pop_up">
              ...
              <div className="pop_up_text">
                ...
                avantages. Vous pouvez choisir uniquement certains avantages ou
                tous les avantages. Des frais seront déduits de votre rendement
                pour assurer ces prestations.
              </div>
              <div className="pop_up_text">
                Concernant le point 1, la libération du paiement des primes en
                cas d’invalidité, la personne peut choisir les délais d’attente
                entre 3,6 ou 12 mois d’attente.
              </div>
              <div className="pop_up_text">
                Si vous n’êtes plus en mesure de travailler suite à une maladie
                ou un accident, la compagnie d’assurance paiera vos primes
                jusqu’à l’âge de votre retraite.
              </div>
              <div className="pop_up_text">
              ...
              <div className="pop_up_text">
                ...
                l’intégralité du montant prévu. Il est impossible de choisir les
                bénéficiaires ou de modifier l’ordre légal car la loi applique
