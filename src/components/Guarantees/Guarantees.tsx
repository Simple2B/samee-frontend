              ...
              <>
                ...
                <div className="pop_up">
                  ...
                  <div className="pop_up_text">
                    ...
                    3<sup>ème</sup> pilier est : « banque ou/ et assurance ? ».
                    Pour y répondre, il est important de bien connaître les
                    différences.
                  </div>
                  <div className="pop_up_text">
                    1) Avec un 3<sup>ème</sup> pilier en assurance, appelé 3
                    <sup>ème</sup> pilier lié, vous avez plus de garanties, en
                    cas d’invalidité et en cas de décès. En cas d’invalidité,
                    c’est l’assurance qui prend le relais et s’occupe du
                    paiement de vos primes. Vous pouvez également toucher une
                    rente complémentaire à votre salaire selon votre contrat. En
                    cas de décès, vos proches obtiennent la totalité du 3
                    <sup>ème</sup> pilier que vous auriez touché à la retraite.
                    Aussi, avec un 3<sup>ème</sup> pilier en assurance, vous
                    avez la garantie d’obtenir 100% du montant inscrit dans
                    votre contrat, à votre retraite. Au contraire du troisième
                    pilier en banque, celui en assurance est une épargne forcée,
                    ce qui peut représenter un avantage, car au moment de payer
                    vos primes vous n’aurez pas d’hésitation et investirez votre
                    argent dans quelque chose de bénéfique pour vous. Il est
                    aussi possible de ne pas payer la prime si une année est
                    plus difficile et de la rattraper l’année suivante par
                    exemple.
                  </div>
                  <div className="pop_up_text">
                    ...
                    pilier en banque, vous ne bénéficiez pas d’une exonération
                    des primes et vous vous retrouvez dans l’incapacité de
                    continuer à cotiser. Finalement, en cas de faillite de la
                    banque, seul 100'000 CHF seraient garantis.
                  </div>
                  <div className="pop_up_text">
                  ...
                  pilier en banque et une autre en assurance. */}
                    En conclusion, même si les deux solutions permettent une
                    économie d’impôts, les assurances sont plus rentables et
                    sécurisées et les banques plus flexibles. Vous avez
                    également la possibilité de placer une partie de votre 3
                    <sup>ème</sup>
