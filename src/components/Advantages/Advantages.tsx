  ...
  return (
    <div className="advantages">
      ...
      <ul className="advantages_list">
        ...
        <li className="advantages_list-item">Logement personnel et création d'entreprise</li>
        <li className="advantages_list-item">Départ à l'étranger et retraite en sécurité</li>
      </ul>
