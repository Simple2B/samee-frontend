          ...
          <>
            ...
            <div className="pop_up">
              ...
              <div className="pop_up_text">
                ...
                intéressant que le capital garanti sans exposer à un risque trop
                élevé. Le taux de 0.20% sur la partie garantie est indicatif et
                dépend du type produit, de la compagnie d'assurance ou de la
