    ...
    <div className="half_guaranteed_for_whom">
      <div className="main_content">
        ...
        <div className="half_guaranteed_for_whom_text">
          Cette solution s’adresse à des personnes à risque contrôlé,
          désireuses d’obtenir un rendement supérieur à un compte épargne,
          mais sans toutefois prendre trop de risques.
        </div>
        <div className="half_guaranteed_for_whom_text">
