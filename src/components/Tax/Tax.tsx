          ...
          <>
            ...
            <div className="pop_up">
              ...
              <div className="pop_up_text">
                L’un des avantages les plus connus du 3ème pilier est l’économie
                qu’il peut vous permettre de réaliser sur vos impôts. En effet,
                c’est un moyen de réduire le montant final que vous devrez
                verser à l’État, tout en capitalisant pour votre retraite. De
                plus, votre épargne au 3ème pilier est exonérée d'impôts jusqu'à
                la retraite.
              </div>
              <div className="pop_up_text">
                ...
                seront importantes. Le montant maximal annuel est actuellement
                de 6'883 CHF pour un salarié et de 34'416 CHF ou de maximum 20%
                de son salaire AVS pour un indépendant.
              </div>
              <div className="pop_up_text">
              ...
              <div className="pop_up_text">
                ...
                avant le 31 décembre de l’année en cours. Le taux de l’impôt sur
                le revenu varie fortement selon le canton où vous résidez.
              </div>
              <div className="pop_up_text">
                Pour calculer votre réduction d’impôts, déduisez les sommes
                annuelles épargnées de votre revenu imposable et appliquez-y le
                taux d’imposition auquel vous êtes soumis.
              </div>
            </div>
          </>
        )}
