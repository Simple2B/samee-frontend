              ...
              <>
                ...
                <div className="pop_up">
                  ...
                  <div className="pop_up_text">
                    ...
                    actuellement de 6'883 CHF pour un salarié et de 34'416 CHF
                    ou de maximum 20% de son salaire AVS pour un indépendant.
                  </div>
                  <div className="pop_up_text">
                    Il est important de savoir que lors du retrait de votre 3ème
                    pilier, vous serez imposé entre 5% et 10% selon les
                  ...
                  <div className="pop_up_text">
                    ...
                    sur le revenu varie fortement selon le canton où vous
                    résidez.
                  </div>
                  <div className="pop_up_text">
