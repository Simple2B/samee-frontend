            ...
            <>
              ...
              <div className="pop_up">
                ...
                <div className="pop_up_text">
                  ...
                  dans une période de 5 ans avant ou après cette date butoir. Si
                  vous souscrivez un troisième pilier en assurance, vous devez
                  inscrire la date d’échéance dans le contrat.
                </div>
                <div className="pop_up_text">
                  ...
                  demander la valeur de rachat de votre 3ème pilier à la
                  compagnie et renseignez-vous auprès de votre conseiller.
                </div>
              </div>
            </>
          )}
