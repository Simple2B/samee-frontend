  ...
  return (
    <div className="solution_for_whom">
      ...
      <div className="solution_for_whom_text">
        ...
        débloquer ou retirer leur 3P pour un projet immobilier ou d’entreprise.
        Dans cette situation, il est important d’avoir une garantie et de ne pas
        risquer son épargne.
      </div>
      <div className="solution_for_whom_text">
        Cette forme de 3ème pilier est également faite pour des personnes à
        faible goût de risque avec un horizon d’investissement à court ou moyen
        terme.
      </div>
