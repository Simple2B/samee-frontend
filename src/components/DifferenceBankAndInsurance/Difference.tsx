  ...
  return (
    <div className="difference">
      <div className="difference_title">
        Vous pouvez ouvrir un troisième pilier en banque ou/et en assurance. Les
        deux solutions ont des avantages.
      </div>
          ...
          <>
            ...
            <div className="pop_up">
              ...
              <div className="pop_up_text">
                ...
                toucher une rente complémentaire à votre salaire selon votre
                contrat. En cas de décès, vos proches obtiennent la totalité du
                3ème pilier que vous auriez touché à la retraite.
              </div>
              <div className="pop_up_text">
              ...
              <div className="pop_up_text">
                ...
                verser de primes, vous êtes libre de le faire. Si vous ne savez
                pas bien gérer vos finances, ce peut être problématique.
                ...
                retrouvez dans l’incapacité de continuer à cotiser. Finalement,
                en cas de faillite de la banque, seul 100'000 CHF seraient
                garantis.
              </div>
